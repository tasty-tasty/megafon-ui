...
import './OldProductCardWrapper.less';
...
const cn = cnCreate('old-product-card-wrapper');
class OldProductCardWrapper extends React.Component<IProductCardWrapperProps, {}> {
    static propTypes = {
...
export default OldProductCardWrapper;
