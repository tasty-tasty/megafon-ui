...
import './OldProductCardTotal.less';
...
const cn = cnCreate('old-product-card-total');
class OldProductCardTotal extends React.Component<IProductCardTotalProps, {}> {
    static propTypes = {
...
export default OldProductCardTotal;
