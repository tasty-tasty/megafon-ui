...
import './OldProductCardFeaturesBottom.less';
import Header from '../Header/Header';
import Paragraph from '../Paragraph/Paragraph';
import { cnCreate } from '../../utils/cn';
import { IShowcaseChildren } from './OldProductCardFeatures';
...
const cn = cnCreate('old-product-card-features-bottom');
class OldProductCardFeaturesBottom extends React.Component<IProductCardFeaturesBottomProps, {}> {
    static propTypes = {
...
export default OldProductCardFeaturesBottom;
