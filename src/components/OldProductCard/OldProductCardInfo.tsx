...
import './OldProductCardInfo.less';
...
const cn = cnCreate('old-product-card-info');
class OldProductCardInfo extends React.Component<IProductCardInfoProps, {}> {
    static propTypes = {
...
export default OldProductCardInfo;
