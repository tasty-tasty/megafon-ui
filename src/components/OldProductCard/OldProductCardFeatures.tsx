...
import './OldProductCardFeatures.less';
...
const cn = cnCreate('old-product-card-features');
class OldProductCardFeatures extends React.Component<IProductCardFeaturesProps, {}> {
    static propTypes = {
...
export default OldProductCardFeatures;
