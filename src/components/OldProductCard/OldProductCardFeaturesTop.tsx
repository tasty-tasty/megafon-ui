...
import './OldProductCardFeaturesTop.less';
import Header from '../Header/Header';
import DropdownSocialList from '../DropdownSocialList/DropdownSocialList';
import { cnCreate } from '../../utils/cn';
import { ISocialIcon, IShowcaseChildren } from './OldProductCardFeatures';
...
const cn = cnCreate('old-product-card-features-top');
class OldProductCardFeaturesTop extends React.Component<IProductCardFeaturesTopProps, {}> {
    static propTypes = {
...
export default OldProductCardFeaturesTop;
